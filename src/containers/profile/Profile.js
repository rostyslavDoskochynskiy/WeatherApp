...
class Profile extends Component {
    ...
    closeModal = () => this.setState({ error: false, currentLocationScreen: <CurrentLocation />  });
    ...
    render() {
        ...
        if(!user){
            ...
            const currentLocationScreen = this.state.currentLocationScreen ? this.state.currentLocationScreen : '';
            const greetingModalText = 'Please tap OK and allow app to get your current location. Thanks:)';
            return (
                <div className="profile" id="js-profile">
                    <div className="profile__container">
                        ...
                        <div className="profile__content">
                            ...
                            />
                            { showCurrentLocation ? currentLocationScreen : error ? <ModalBasic
                                    id="modal"
                                    closeModal={this.cancelError}
                                    classNameText="signup__title"
                                    className="signup__modal"
                                    container="js-profile" text={ locationError }
                                />
                                :
                                <Weather selectedLocation={ selectedLocation ? selectedLocation : {} } {...this.props} />}
                        </div>
                    </div>
                </div>
            );
