...
class Weather extends Component {
  ...
  componentWillReceiveProps() {
    ...
    const {
      consolidated_weather: currentWeatherFiveForecast,
      title: cityName
        ...
        <tr key={i} className="weather__table-tr">
          ...
          <td className="weather__table-td">
            <p className="high-temp">
              {max_temp}
              <sup className="high-temp-icon">&deg;</sup>
            </p>
          </td>
          <td className="weather__table-td">
            <p className="low-temp">
              {min_temp}
              <sup className="low-temp-icon">&deg;</sup>
            </p>
          </td>
        </tr>
      );
      ...
      <>
        {!cityName ? (
          ...
          <Text
            ...
            type="span"
            text={`5-day ${cityName} Weather Forecast`}
          />
        )}
  ...
  render() {
    return <div className="weather">{this.renderData()}</div>;
  }
}
